...
age_train_df = pd.read_csv('dataset2.0/age.tsv', sep='\t')
...
country_train_df = pd.read_csv('dataset2.0/country.tsv', sep='\t')
...
gender_train_df = pd.read_csv('dataset2.0/gender.tsv', sep='\t')
...
ethnicity_train_df = pd.read_csv('dataset2.0/ethnicity.tsv', sep='\t')
