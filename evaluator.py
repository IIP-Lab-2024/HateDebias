...
def eval(dpath):
    ...
    '''
    df = pd.read_csv(dpath, sep='\t', na_values='x', quoting=csv.QUOTE_NONE)
    # print(df.shape)
    ...
    for task in tasks:
        ...
        for group in uniq_types:
            ...
            # print(group_df.label.shape)
            # print(group_df.pred.shape)
            # print(group_df.label)
            # print(group_df.pred)
            try:
                ...
                g_tn, g_fp, g_fn, g_tp = 3, 0, 0, 0
                # print(g_tn, g_fp, g_fn, g_tp)
    ...
    print(scores['accuracy'],'\t',scores['f1-macro'],'\t',scores['f1-weight'],'\t',scores['auc'],'\t',scores['gender']['fped'],'\t',scores['age']['fped'],'\t',scores['country']['fped'],'\t',scores['ethnicity']['fped'])
    return scores
