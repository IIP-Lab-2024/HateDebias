...
for sequence in sequence_list:
    ...
    save_path = 'Fine-tune-' + item1[0] + item2[0] + item3[0] + item4[0]
    os.system(
        'python3 Fine-Tune.py --attribute1 %s --attribute2 %s --attribute3 %s --attribute4 %s --save_path %s' % (item1, item2, item3, item4, save_path)
    )