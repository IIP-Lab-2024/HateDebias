...
Options:
    ...
    --attribute2=<str>              attribute2 [default: ethnicity]
    --attribute3=<str>              attribute3 [default: gender]
    --attribute4=<str>              attribute4 [default: age]
    --save_path=<str>              save_path [default: Sequence-CL-SensitiveReplay-0.1-0.1-0.1-cega]
...
for attribute_num, attribute in enumerate(attribute_list):
    if attribute_num == 0:
        ...
        for pred_num in range(attribute_num):
            ...
            sample_dataset = select_pretask_samples(dataset['df'][attribute_list[pred_num]],model)
