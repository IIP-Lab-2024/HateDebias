            ...
            for pre_task in pre_task_train_iter:
                ...
                for batch in pre_task_train_dl:
                    ...
                    if pre_model != None:
                        ...
                        loss = loss + GCONF.task_weight * (sp_loss + ge_loss + task_loss + double_id_loss)
...
for filename in glob.glob('/date3/lnk/DynamicFairness-Model/Sequence-CL-Replay-Double-0.1-0.1-0.1-*'):
